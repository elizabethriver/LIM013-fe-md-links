...
const validateLinks = (route) => {
  ...
  arryUrl.push(axios.get(link.href)
    ...
    .catch(() => {
      ...
      console.log(urlObj);
      // console.log('You have links not validate');
      return urlObj;
    })
  ));
  // console.log('You have array of fail and oks links');
  return Promise.all(arryUrl);
};


// validateLinks(md).then(() => {
//   console.log('You got the links');
// })
// .catch(() => {
//   console.log('Oops, something happened');
// })
// console.log(validateLinks(extractLinks(route)));
...
module.exports = { validationPath, pathisAbsolute, pathBecameAbsolute, files, stats, extname, isDirectory, isFile, fileMd, pathAbsolute, readFile, getAllFiles, isFileOrDiectory, extractLinks, validateLinks };
