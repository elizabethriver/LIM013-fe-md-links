...
const folderPath = 'C:\\Users\\ELIZABETH\\Documents\\Laboratoria\\LIM013-fe-md-links\\test\\';

  console.log(fs.readdirSync(folderPath).map(fileName => {
    return path.join(folderPath, fileName)
  }));

  fs.readFile('C:\\Users\\ELIZABETH\\Documents\\Laboratoria\\LIM013-fe-md-links\\test\\example\\texto.tx', 'utf8' , (err, data) => {
    if (err) {
      console.error(err)
      return
    }
